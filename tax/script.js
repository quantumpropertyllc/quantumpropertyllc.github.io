...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.TaxCore.Forms.SSA1099 && window.TaxCore.Forms.SSA1099.init) window.TaxCore.Forms.SSA1099.init();
    ...
    window.TaxCore.State.subscribe((state) => {
        window.TaxCore.Forms.R.updateList(state.forms.r);
        if (window.TaxCore.Forms.SSA1099) window.TaxCore.Forms.SSA1099.updateList(state.forms.ssa || []);
